...
- パターン 0 (diff=0): 0 + 0m
- パターン 1 (diff=4): 7 + 32m
- パターン 2 (diff=6): 11 + 48m
- パターン 3 (diff=10): 18 + 80m
- パターン 4 (diff=12): 22 + 96m
- パターン 5 (diff=16): 29 + 128m
- パターン 6 (diff=22): 41 + 176m
- パターン 7 (diff=24): 44 + 192m

### 素数候補 11系列 (j=11) の各式:
- パターン 0 (diff=0): 0 + 0m
- パターン 1 (diff=2): 6 + 16m
- パターン 2 (diff=6): 17 + 48m
- パターン 3 (diff=8): 23 + 64m
- パターン 4 (diff=12): 35 + 96m
- パターン 5 (diff=18): 53 + 144m
- パターン 6 (diff=20): 58 + 160m
- パターン 7 (diff=26): 76 + 208m

### 素数候補 13系列 (j=13) の各式:
- パターン 0 (diff=0): 0 + 0m
- パターン 1 (diff=4): 13 + 32m
- パターン 2 (diff=6): 20 + 48m
- パターン 3 (diff=10): 34 + 80m
- パターン 4 (diff=16): 55 + 128m
- パターン 5 (diff=18): 62 + 144m
- パターン 6 (diff=24): 83 + 192m
- パターン 7 (diff=28): 97 + 224m

### 素数候補 17系列 (j=17) の各式:
- パターン 0 (diff=0): 0 + 0m
- パターン 1 (diff=2): 9 + 16m
- パターン 2 (diff=6): 27 + 48m
- パターン 3 (diff=12): 54 + 96m
- パターン 4 (diff=14): 63 + 112m
- パターン 5 (diff=20): 90 + 160m
- パターン 6 (diff=24): 108 + 192m
- パターン 7 (diff=26): 117 + 208m

### 素数候補 19系列 (j=19) の各式:
- パターン 0 (diff=0): 0 + 0m
- パターン 1 (diff=4): 20 + 32m
- パターン 2 (diff=10): 50 + 80m
- パターン 3 (diff=12): 61 + 96m
- パターン 4 (diff=18): 91 + 144m
- パターン 5 (diff=22): 111 + 176m
- パターン 6 (diff=24): 121 + 192m
- パターン 7 (diff=28): 142 + 224m

### 素数候補 23系列 (j=23) の各式:
- パターン 0 (diff=0): 0 + 0m
- パターン 1 (diff=6): 36 + 48m
- パターン 2 (diff=8): 49 + 64m
- パターン 3 (diff=14): 85 + 112m
- パターン 4 (diff=18): 110 + 144m
- パターン 5 (diff=20): 122 + 160m
- パターン 6 (diff=24): 147 + 192m
- パターン 7 (diff=26): 159 + 208m

### 素数候補 29系列 (j=29) の各式:
- パターン 0 (diff=0): 0 + 0m
- パターン 1 (diff=2): 15 + 16m
- パターン 2 (diff=8): 62 + 64m
- パターン 3 (diff=12): 93 + 96m
- パターン 4 (diff=14): 108 + 112m
- パターン 5 (diff=18): 139 + 144m
- パターン 6 (diff=20): 154 + 160m
- パターン 7 (diff=24): 185 + 192m

### 素数候補 31系列 (j=31) の各式:
- パターン 0 (diff=0): 0 + 0m
- パターン 1 (diff=6): 49 + 48m
- パターン 2 (diff=10): 82 + 80m
- パターン 3 (diff=12): 99 + 96m
- パターン 4 (diff=16): 132 + 128m
- パターン 5 (diff=18): 149 + 144m
- パターン 6 (diff=22): 182 + 176m
- パターン 7 (diff=28): 231 + 224m
*/
...
// --- 主関数群 ---
// ベース篩
size_t baseSieve(ull hi, ull* basePrimes){
    ...
    for(ull i = 1; mul <= (ull)(sqrt(hi) / 30) + 1; i += 8, mul++){
        ...
        for(int j = 0; j < 8; j++){
            if(getBit(sieve, i + j)){
                // 素数の値を復元
                ull prime = mul30 + (ull)constWheel30Offsets[j];
                ull idx = (prime * prime) / 30;
                ll offsetIdx[8];
                char masks[8];
                // オフセットとマスクを取得
                for(int k = 0; k < 8; k++){
                    offsetIdx[k] = (ll)offsetIdxConst[j][k] + (ll)offsetIdxCoeff[j][k] * mul;
                    masks[k] = ~(1 << offsetMod8[j][k]);
                }
                // メインループ
                ll max_offset_ll = offsetIdx[7];
                ull maxOffset = max_offset_ll > 0 ? max_offset_ll : 0;
                ...
                for(; idx < limitByte; idx += prime){
                    for(int k = 0; k < 8; k++){
                        ll currentIdx = (ll)idx + offsetIdx[k];
                        if(currentIdx >=0 && (ull)currentIdx < limitByte){
                            sieve[(ull)currentIdx] &= masks[k];
                        }
                    }
                }
            }
    ...
    if(hi >= 2){
        if (basePrimes) basePrimes[primeCount] = 2;
        primeCount++;
    }
    if(hi >= 3){
        if (basePrimes) basePrimes[primeCount] = 3;
        primeCount++;
    }
    if(hi >= 5){
        if (basePrimes) basePrimes[primeCount] = 5;
        primeCount++;
    }
    int flag = 0;
    for (ull i = 0; i < sieveSize; i++) {
        ...
        for (int bit = 0; bit < 8; bit++) {
            if (sieve[i] & (1 << bit)) {
                ...
                if (prime <= hi) {
                    if (basePrimes) basePrimes[primeCount] = prime;
                    primeCount++;
                } else {
                    flag = 1;
                    break;
...
// 区間篩
size_t segmentSieve(ull lo, ull hi, ull* basePrimes, size_t basePrimesSize, ull user_lo){ 
    // ベース篩と基本同じだがloによるオフセットがある。また最初のビット反転はしない。入力にベース篩からの素数リストが必要。
    ull seg_size_bytes = (hi - lo) / 30 + 1;
    std::vector<unsigned char> sieve(seg_size_bytes, 0xFF); // 全ビットを1に初期化 (この配列は[lo + 1, lo + 7, lo + 11, lo + 13, lo + 17, lo + 19, lo + 23, lo + 29...]というふうに対応。)
    ull loByte = lo / 30;
    ull limitByte = seg_size_bytes;
    ...
    size_t primeCount = 0; // 素数の個数
    int flag = 0;
    for (ull i = 0; i < seg_size_bytes; i++) {
        if (sieve[i] == 0) continue; // 全ビットが0ならスキップ
        for (int bit = 0; bit < 8; bit++) {
            if (sieve[i] & (1 << bit)) {
...
// 篩の制御用
ull sieveCompute(ull lo, ull hi, int mode){
    // 配列を確保   
    ull limit = ((ull)sqrt((double)hi) / 30) * 30 + 30; // 30の倍数に切り捨て

    ull segmentSize = SEGMENT_SIZE;
    ull primeCount = 0;

    // モードに応じて篩を実行
    if(mode == 0){ // 0: 2からhiまでの素数を求める
        if(961 < hi){ // hiが961より大きい場合は区間篩を使う。961は31^2。
            ...
            size_t basePrimesCount = baseSieve(limit, basePrimes.data());
            primeCount += basePrimesCount;
            for (ull i = limit; i <= hi; i += segmentSize) {
                ull current_hi = std::min(i + segmentSize - 1, hi);
                primeCount += segmentSieve(i, current_hi, basePrimes.data(), basePrimesCount, i);
            }
        } else {
            // hiが961以下の場合はベース篩のみで完結する
            primeCount = baseSieve(hi, nullptr);
        }
        ...
        if(lo <= 2 && hi >= 2) primeCount++;
        if(lo <= 3 && hi >= 3) primeCount++;
        if(lo <= 5 && hi >= 5) primeCount++;

        ull lo30 = lo / 30 * 30;
        for (ull i = lo30; i <= hi; i += segmentSize) {
            ull current_hi = std::min(i + segmentSize - 1, hi);
            if (current_hi < lo) continue;
            primeCount += segmentSieve(i, current_hi, basePrimes.data(), basePrimesCount, lo);
...
int main(int argc, char *argv[]){
    ...
    */
    if(argc > 3){
        ...
        ull primeCount = sieveCompute(2, hi, 0);
        ...
        auto start = std::chrono::high_resolution_clock::now();
        ull primeCount = sieveCompute(lo, hi, 1);
        auto end = std::chrono::high_resolution_clock::now();
        std::chrono::duration<double> elapsed = end - start;
